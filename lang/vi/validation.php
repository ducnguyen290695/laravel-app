...
return [
    ...
    | lớp xác thực. Một số quy tắc có nhiều phiên bản như các quy tắc kích thước.
    | Bạn có thể tự do chỉnh sửa từng thông báo này tại đây.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Giá trị :attribute đã xuất hiện trong vụ rò rỉ dữ liệu. Vui lòng chọn một :attribute khác.',
    ],
    ...
    'present_with_all' => 'Trường :attribute phải tồn tại khi tất cả :values tồn tại.',
    ...
    'prohibits' => 'Trường :attribute ngăn cản :other tồn tại.',
    ...
    */
    ...
    | bằng một thứ gì đó thân thiện hơn với người đọc như "Địa chỉ E-Mail" thay vì
    | "email". Điều này giúp thông điệp của chúng ta trở nên rõ ràng hơn.
    |
    */
